...
```
***
## 4. ¿Qué es MongoDB una base de datos SQL o NoSQL?
...
# Función polimórfica: no importa el tipo de objeto, solo que sepa 'desplazarse'
